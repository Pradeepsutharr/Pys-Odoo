export const service_details = [
  ...
  },
  {
    ...
    key_points: [
      "Odoo Modules (Sales, Inventory, HR, etc.)",
      "Workflows & Automation",
      "Reports & Dashboards",
      "User Roles & Access Rights",
      "Frontend UI/UX (eCommerce, POS)",
    ],
    small_image: "",
  },
  {
    ...
    key_points: [
      ...
      "Shipping & Logistics: ShipRocket, FedEx",
    ],
    small_image: "",
  },
  {
    ...
    key_points: [
      "Migration from legacy systems (SAP, Tally, Zoho, etc.)",
      "Odoo version upgrades (e.g., v12 to v17)",
  ...
  },
  {
    ...
    key_points: [
      "Functional Training (Sales, CRM, Inventory, etc.)",
      "Technical Training (Developers & Admins)",
      "Custom Workshops for your business",
    ],
    small_image: "",
  },
];
